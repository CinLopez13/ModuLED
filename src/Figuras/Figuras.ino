...
// Defina el tipo de hardware, el tamaño y los pines 
...
// Cree un objeto MAX72xx 
MD_MAX72XX display(HARDWARE_TYPE, PIN_DIN, PIN_CLK, PIN_CS, MAX_DEVICES);

// Mapas de bits para animaciones 
byte smiley[2][8] = { 
...
// Definiciones de mapa de bits para caracteres ASCII 
const byte ASCII[][8] = { 
...
void scrollText(const char *pText) {
    ...
    for (int position = -MAX_DEVICES * 8; position < maxPosition; position++) { 
        display.clear(); // Asegúrese de que la pantalla se borre en cada fotograma 
        ...
        for (int col = 0; col < MAX_DEVICES * 8; col++) { 
            ...
            if (charIndex >= 0 && charIndex < textLength) { 
                ...
                int bitmapIndex = ch - 32; // Calcule el índice correcto en la matriz de mapa de bits 
